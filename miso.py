...
def get_logo_path():
    ...
    if hasattr(sys, "_MEIPASS"):
        return os.path.join(sys._MEIPASS, "misololo.png")
    elif os.path.exists("/usr/share/icons/hicolor/48x48/apps/misololo.png"):
        return "/usr/share/icons/hicolor/48x48/apps/misololo.png"
    elif os.path.exists("misololo.png"):
        return "misololo.png"
    return None
